...
EOF
printf firmware > "$ipq60_variant/immortalwrt-jdcloud_re-cs-02-squashfs-sysupgrade.bin"
...
EOF
printf firmware > "$ipq60_large_variant/immortalwrt-linksys_mr7500-squashfs-sysupgrade.bin"
